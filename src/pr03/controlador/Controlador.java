...
public class Controlador extends HttpServlet {
	...
	*/
     ...
     * fuente de datos es la base de datos bdpr03.
     */
  private DataSource dspr03;
	/**
	...
	// aplicación. 
	    try {
	    	...
	    	setDspr03((DataSource) initCtx.lookup("java:jboss/datasources/dspr03"));
	    	if (getDspr03()==null)
	    		System.out.println("dspr03 es null.");
	    	sc = config.getServletContext();
	    	// El datasource se almacena a nivel de aplicación.
	    	sc.setAttribute("dspr03", getDspr03());
   ...
   * @param dspr03 Acceso a la base de datos bdpr03.
   */
	public void setDspr03(DataSource dspr03) {
		this.dspr03 = dspr03;
	}

    /**
     * Obtiene la referencia a la fuente de datos de la aplicación.
     * @return La fuente de datos asociada a la base de datos bdpr03.
     */
	public DataSource getDspr03() {
		return dspr03;
	}
